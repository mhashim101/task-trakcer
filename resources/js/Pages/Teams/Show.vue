        ...
        <div class="p-6 bg-white border-b border-gray-200">
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div class="col-span-2">
              <h3 class="text-lg font-semibold text-gray-800 mb-4">Team Information</h3>
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <div class="mb-4">
                    <div class="text-sm font-medium text-gray-500">Team Name</div>
                    <div class="mt-1 text-sm text-gray-900">{{ team.name }}</div>
                  </div>
                  
                  <div class="mb-4">
                    <div class="text-sm font-medium text-gray-500">Created On</div>
                    <div class="mt-1 text-sm text-gray-900">{{ new Date(team.created_at).toLocaleDateString() }}</div>
                  </div>
                </div>
                
                <div>
                  <div class="mb-4">
                    <div class="text-sm font-medium text-gray-500">Team Lead</div>
                    <div class="mt-1 text-sm text-gray-900">ID: {{ team.team_lead_id }}</div>
                  </div>
                  
                  <div class="mb-4">
                    <div class="text-sm font-medium text-gray-500">Last Updated</div>
                    <div class="mt-1 text-sm text-gray-900">{{ new Date(team.updated_at).toLocaleDateString() }}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-span-2 mt-6">
              <div class="flex justify-between items-center mb-4">
                ...
                <button class="px-3 py-1 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700 transition">
                  Add Member
                </button>
              </div>
              
              <div class="bg-gray-100 p-8 text-center rounded-md">
                <p class="text-gray-500">Team members would be displayed here.</p>
                <p class="text-sm text-gray-400 mt-2">This would require additional data from the backend.</p>
              </div>
            </div>
          </div>
        </div>
