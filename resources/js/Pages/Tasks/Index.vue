...
const props = defineProps({
  ...
  auth: Object, // Authenticated user
})
  ...
  <div class="dashboard-container">
    ...
    <div class="flex">
      ...
      <div class="flex-1 py-12 px-6">
        <header class="bg-white p-4 flex items-center justify-between border-b">
          <h2 class="font-semibold text-xl text-gray-800">Tasks</h2>
          <div v-if="auth.user && (auth.user.isTeamLead || auth.user.isAdmin)">
            <Link href="/tasks/create" class="bg-blue-500 text-white px-4 py-2 rounded">Create Task</Link>
          </div>
        </header>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="task in tasks" :key="task.id">
                    <td class="px-6 py-4 whitespace-nowrap">
                      <Link :href="`/tasks/${task.id}`" class="text-blue-600 hover:text-blue-900">{{ task.title }}</Link>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <Link :href="`/team-lead/tasks/${task.id}`" class="text-blue-600 hover:text-blue-900">View</Link>
                      <Link
                        :href="`/team-lead/tasks/${task.id}/edit`"
